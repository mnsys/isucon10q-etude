...
func main() {
	...
	dbchair, err = chairmySQLConnectionData.ConnectDB()
	dbestate, err = estatemySQLConnectionData.ConnectDB()
	if err != nil {
		e.Logger.Fatalf("DB connection failed : %v", err)
	}
	dbchair.SetMaxOpenConns(10) // TODO:確認
	defer dbchair.Close()

	dbestate.SetMaxOpenConns(10) // TODO:確認
